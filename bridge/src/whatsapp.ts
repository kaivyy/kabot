...
export class WhatsAppClient {
  ...
  async sendMediaMessage(
    ...
    // Determine media source (URL or Buffer from file)
    if (isUrl) {
      mediaContent = { url: pathOrUrl };
    } else {
    ...
    switch (mediaType) {
      ...
      case 'audio':
        messageContent = {
          audio: mediaContent,
          mimetype: options?.mimetype || 'audio/mp4' // PTT requires audio/mp4
        };
        break;
