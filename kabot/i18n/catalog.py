...
_CATALOG: dict[str, dict[str, str]] = {
    "en": {
        ...
        "filesystem.file_not_found": "I couldn't find that file yet: {path}",
        ...
        "filesystem.directory_not_found": "I couldn't find that folder yet: {path}",
        ...
        "stock.fetch_failed": "I couldn't get a live quote for {symbol} right now. The provider may be blocked or rate-limited, and I don't want to guess the latest price. Use web_search if available, or send an exact finance URL, screenshot, or pasted number.",
    ...
    "id": {
        ...
        "filesystem.file_not_found": "Aku belum menemukan file ini: {path}",
        ...
        "filesystem.directory_not_found": "Aku belum menemukan folder ini: {path}",
        ...
        "stock.fetch_failed": "Saya belum bisa ambil harga live untuk {symbol} sekarang. Provider bisa saja memblokir atau rate-limit request ini, dan saya tidak mau menebak angka terbaru. Kalau web_search tersedia pakai itu; kalau tidak, kirim link finance yang tepat, screenshot, atau angkanya.",
    ...
    "ms": {
        ...
        "filesystem.file_not_found": "Saya belum menjumpai fail ini: {path}",
        ...
        "filesystem.directory_not_found": "Saya belum menjumpai folder ini: {path}",
        "filesystem.permission_denied": "Akses ditolak: {error}",
        ...
        "stock.fetch_failed": "Saya belum dapat ambil harga langsung untuk {symbol} sekarang. Provider mungkin menyekat atau mengehadkan permintaan ini, dan saya tidak mahu meneka angka terkini. Jika web_search tersedia guna itu; jika tidak, kirim pautan kewangan yang tepat, tangkap layar, atau nombornya.",
