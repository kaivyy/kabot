...
PROVIDERS: tuple[ProviderSpec, ...] = (
    ...
    ProviderSpec(
        ...
        env_extras=(("MISTRAL_API_BASE", "{api_base}"),),
    ...
    ProviderSpec(
        ...
        strip_model_prefix=True,
        env_extras=(("HUGGINGFACE_HUB_TOKEN", "{api_key}"),),
    ),
    ProviderSpec(
        name="qianfan",
        keywords=("qianfan/",),
        ...
        is_gateway=True,
        detect_by_base_keyword="qianfan.baidubce.com",
    ...
    ProviderSpec(
        ...
        is_gateway=True,
        detect_by_base_keyword="cerebras.ai",
    ...
    ProviderSpec(
        ...
        default_api_base="https://api.opencode.ai/v1",
        strip_model_prefix=True,
    ),
    ProviderSpec(
        name="xiaomi",
        ...
        is_gateway=True,
        detect_by_base_keyword="xiaomimimo.com",
        default_api_base="https://api.xiaomimimo.com/anthropic",
        strip_model_prefix=True,
    ),
    ProviderSpec(
        name="volcengine",
    ...
    ProviderSpec(
        ...
        is_gateway=True,
        detect_by_base_keyword="bytepluses.com",
    ...
    ProviderSpec(
        ...
        is_gateway=True,
        detect_by_base_keyword="api.synthetic.new",
        default_api_base="https://api.synthetic.new/anthropic",
        strip_model_prefix=True,
    ),
    ProviderSpec(
        name="cloudflare-ai-gateway",
        keywords=("cloudflare-ai-gateway/",),
        env_key="CLOUDFLARE_AI_GATEWAY_API_KEY",
        display_name="Cloudflare AI Gateway",
        is_gateway=True,
        detect_by_base_keyword="gateway.ai.cloudflare.com",
        default_api_base="https://gateway.ai.cloudflare.com/v1",
        strip_model_prefix=True,
    ),
    ProviderSpec(
