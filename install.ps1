...
"@ | Out-File -FilePath $wrapperPath -Encoding ASCII
    ...
    Write-Host "  1. Edit your configuration: $InstallDir\config.json"
    Write-Host "  2. Add your API key (e.g., OpenRouter)"
    Write-Host "  3. Start the gateway: kabot gateway"
    Write-Host "  4. Or chat directly: kabot agent -m 'Hello!'"
    Write-Host ""
