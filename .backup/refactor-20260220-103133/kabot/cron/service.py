...
def _compute_next_run(schedule: CronSchedule, now_ms: int) -> int | None:
    ...
    if schedule.kind == "every":
        ...
        logger.debug(
            f"Computing every: now={now_ms}, interval={schedule.every_ms}, "
                ...
                for j in data.get("jobs", []):
                    ...
                    jobs.append(CronJob(
                        ...
                        schedule=CronSchedule(
                            ...
                            start_at_ms=j["schedule"].get("startAtMs"),
                        ...
                        payload=CronPayload(
                            ...
                            to=j["payload"].get("to"),
                            group_id=j["payload"].get("groupId"),
                            group_title=j["payload"].get("groupTitle"),
                        ),
                        state=CronJobState(
            ...
            "jobs": [
                {
                    ...
                    "schedule": {
                        ...
                        "startAtMs": j.schedule.start_at_ms,
                    ...
                    "payload": {
                        ...
                        "to": j.payload.to,
                        "groupId": j.payload.group_id,
                        "groupTitle": j.payload.group_title,
                    },
                    "state": {
